...
# Type: ModelAttributeReference


A reference to an attribute defined in the CTS2 specification.

URI: [https://hotecosystem.org/tccm/filtersandsorting/ModelAttributeReference](https://hotecosystem.org/tccm/filtersandsorting/ModelAttributeReference)
