 ...
 * [ValueSetDescription](ValueSetDescription.md) (mixin)  - A description of a value

## Referenced by class

 *  **None** *[➞predecessor](resourceVersionDescription__predecessor.md)*  <sub>OPT</sub>  **[NameAndMeaningReference](NameAndMeaningReference.md)**
