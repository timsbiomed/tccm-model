...
# Type: nameAndMeaningReference__name


An identifier that uniquely names the reference within the context of the particular reference type.

URI: [https://hotecosystem.org/tccm/sorting/nameAndMeaningReference__name](https://hotecosystem.org/tccm/sorting/nameAndMeaningReference__name)
