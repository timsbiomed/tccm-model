...
# Type: FormalityLevelReference


A reference to a description of the relative formality an ontology.

URI: [https://hotecosystem.org/tccm/filtersandsorting/FormalityLevelReference](https://hotecosystem.org/tccm/filtersandsorting/FormalityLevelReference)
