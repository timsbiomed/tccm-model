 ...
 *  **None** *[➞valueSet](completeValueSetReference__valueSet.md)*  <sub>REQ</sub>  **[ValueSetReference](ValueSetReference.md)**
 *  **None** *[➞definitionOf](valueSetDefinition__definitionOf.md)*  <sub>OPT</sub>  **[ValueSetReference](ValueSetReference.md)**
