...
# Type: nameAndMeaningReference__uri




URI: [tccm:nameAndMeaningReference__uri](https://hotecosystem.org/tccm/nameAndMeaningReference__uri)


## Domain and Range

None ->  <sub>OPT</sub> [ExternalURI](types/ExternalURI.md)
 ...
 * [ValueSetDescription](ValueSetDescription.md)
