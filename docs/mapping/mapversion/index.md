 ...
 * [MapEntry](MapEntry.md) - A "complex map" that defines an ordered set of rules for mapping from "`mapFrom`" to one or more targets
 * [MapSet](MapSet.md)
 * [MapTarget](MapTarget.md)
 * [MapVersion](MapVersion.md) - A specific version of a Map. MapVersion is bound to specific code system versions and/or value set
 ...
 * [SimpleMapEntry](SimpleMapEntry.md) - A map entry represents the set of mappings that share the same mapFrom entity identifier. There may be at most
 ...
 * [➞entries](fullMapVersion__entries.md) - An ordered set of rules for performing a complex map
 * [➞allMatchesFrom](mapEntry__allMatchesFrom.md) - Process all map sets, returning every set that has a matching target
 * [➞firstMatchFrom](mapEntry__firstMatchFrom.md) - Processing stop at the first map set that has a matching target.
 * [➞mapFrom](mapEntry__mapFrom.md) - The source entity.  EntityReference must be a member of the fromValueSetDefinition part of the map definition.
 * [➞allMatchesFrom](mapSet__allMatchesFrom.md) - Process all map targets returning every target that has a matching rule
 * [➞firstMatchFrom](mapSet__firstMatchFrom.md) - Processing stops on the first target with a matching rule
 * [➞correlation](mapTarget__correlation.md) - A reference to how well the mapping correlates. Example correlations might be Exact, not mappable, partial
 * [➞mapTo](mapTarget__mapTo.md) - The target entity to be used if the rule is satisfied. If not present, the assumption is that the source
 * [➞rule](mapTarget__rule.md) - A predicate of some sort that can be used to determine whether this entry meets the mapping criteria. If
 * [➞targetDescription](mapTarget__targetDescription.md) - A description of the resulting rule. Can be used to carry text to instruct human beings how to do the
 * [➞targetExpression](mapTarget__targetExpression.md) - A formal expression that, when interpreted, results in the map target. This expression could carry an RDF
 * [➞map](mapVersionReference__map.md)
 * [➞applicableContext](mapVersion__applicableContext.md) - References to the realm, context, or other external factor that determines the applicability of this
 * [➞fromCodeSystemVersion](mapVersion__fromCodeSystemVersion.md) - The specific code system version that provided the from entities in this map.
 * [➞fromValueSetDefinition](mapVersion__fromValueSetDefinition.md) - The specific value set definition that was used to resolve the from entities in this map.
 * [➞mapVersionName](mapVersion__mapVersionName.md) - A local identifier that uniquely names this version within the context of the CTS2 service implementation.
 * [➞toCodeSystemVersion](mapVersion__toCodeSystemVersion.md) - The specific code system version that provided the to entities in this map.
 * [➞toValueSetDefinition](mapVersion__toValueSetDefinition.md) - The specific value set definition that was used to resolve the to entities in this map.
 * [➞useCodeSystemVersion](mapVersion__useCodeSystemVersion.md) - A list of code system versions that should be used in the resolution of fromValueSetDefinition and/or
 * [➞versionOf](mapVersion__versionOf.md) - A reference to the Map resource that this is a version of.
 * [➞versionTag](mapVersion__versionTag.md) - A version tag assigned to this MapVersion instance by the implementing service.
 ...
 * [➞correlation](simpleMapEntry__correlation.md) - A reference to how well the mapping correlates. Example correlations might be Exact, not mappable, partial
 * [➞mapFrom](simpleMapEntry__mapFrom.md) - The source entity.  EntityReference must be a member of the fromValueSetDefinition part of the map definition.
 * [➞mapTo](simpleMapEntry__mapTo.md) - The target entity.  EntityReference must be a member of the toValueSetDefinition part of the map definition.
 * [➞entries](simpleMapVersion__entries.md) - A set of entries in this map
